...
<div class="row justify-content-center">
    <div class="col-lg-7">
        ...
        @if(\Cart::getTotalQuantity()>0)
            <h4>{{ \Cart::getTotalQuantity() }} Shoe(s) In Your Cart</h4><br>

            @foreach($cartCollection as $shoe)
                <div class="row">
                    <div class="col-lg-3">
                        <img src="{{ asset($shoe->attributes->image) }}" class="img-thumbnail" width="200"
                            height="200">
                    </div>
                    <div class="col-lg-5">
                        <p>
                            ...
                            <form action="{{ route('cart.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" class="form-control form-control-sm"
                                        value="{{ $shoe->quantity }}" id="quantity" name="quantity"
                                        style="width: 70px; margin-right: 10px;">
                                    <button class="btn btn-success btn-sm" style="margin-right: 25px;"><i
