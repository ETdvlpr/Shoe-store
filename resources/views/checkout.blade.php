...
@endif
      ...
      <div class="row">
        ...
        @foreach($cartItems as $shoe)
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                ...
                <small class="text-muted">Qty: {{$shoe->quantity}}</small>
              </div>
              <span class="text-muted">{{ number_format(\Cart::get($shoe->id)->getPriceSum()) }} {{$shoe->attributes->currency}}</span>
            </li>
        @endforeach
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate action="{{ route('pay') }}" method="POST">
            {{ csrf_field() }}
            <div class="row">
